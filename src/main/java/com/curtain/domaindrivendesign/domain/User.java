package com.curtain.domaindrivendesign.domain;
...
import com.curtain.domaindrivendesign.domain.valueobject.Address;
...
public class User extends BosEntity implements UserDetails {
    ...
    @DomainEvents
    TestEvent domainEvents() {
        //todo  只要调用save就会触发   失败时也会。
        return new TestEvent(this, "user");
    }
